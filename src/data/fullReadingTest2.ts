...
const elmPeopleOptions = [
  'A. Matt Elliot',
  'B. Karen Russell',
  'C. Peter Bourne',
]

const stressEndingOptions = [
...
const passage1: Section = {
  ...
  questions: [
    ...
    },
    {
      ...
      text: 'diet consists of fern fronds, various parts of a tree and ______.',
      correctAnswer: 'bulbs',
    ...
    },
    {
      ...
      number: 8,
      type: 'summary-completion',
      text: 'nests are created in ______ where eggs are laid',
      correctAnswer: 'soil',
      location: 'Paragraph C',
    },
    {
      ...
      number: 9,
      type: 'summary-completion',
      text: 'the ______ of the kakapo were used to make clothes',
    ...
    },
    {
      ...
      number: 10,
      type: 'summary-completion',
      text: '______ were an animal which they introduced that ate the kakapo food sources',
      correctAnswer: 'deer',
      location: 'Paragraph D',
    },
    {
      ...
      number: 11,
      type: 'summary-completion',
      text: 'a definite sighting of female kakapo on Rakiura Island was reported in the year ______',
      correctAnswer: '1980',
    ...
    },
    {
      ...
      number: 12,
      type: 'summary-completion',
      text: 'the Recovery Plan included an increase in ______',
    ...
    },
    {
      ...
      number: 13,
      type: 'summary-completion',
      text: 'a current goal of the Recovery Plan is to maintain the involvement of ______ in kakapo protection',
...
const passage2: Section = {
  id: 'elm-return-p2',
  title: 'Reading Passage 2: Return of the elm',
  paragraphs: [
    {
      label: 'A',
      content:
        "Return of the elm: reintroducing the beloved tree to Britain. Mark Rowe investigates attempts to reintroduce elms to Britain. Around 25 million elms, accounting for 90% of all elm trees in the UK, died during the 1960s and '70s of Dutch elm disease. In the aftermath, the elm, once so dominant in the British landscape, was largely forgotten. However, there's now hope the elm may be reintroduced to the countryside of central and southern England. Any reintroduction will start from a very low base. \"The impact of the disease is difficult to picture if you hadn't seen what was there before,\" says Matt Elliot of the Woodland Trust. \"You look at old photographs from the 1960s and it's only then that you realise the impact [elms had]...They were significant, large trees...then they were gone.\"",
    },
    {
      label: 'B',
      content:
    ...
    },
    {
      label: 'H',
      content:
        'Glossary: * horticultural analogue: a cultivated plant species that is genetically similar to an existing species.',
    },
  ],
  questions: [
    {
      ...
      instruction:
        'Reading Passage 2 has seven sections. Which section contains the following information? You may use any letter more than once.',
    ...
    },
    {
      ...
      text: 'For hundreds of years, the only tree that was more popular in Britain than elm was ______.',
      correctAnswer: 'oak',
      location: 'Paragraph D',
    },
    {
      ...
      number: 25,
      type: 'summary-completion',
      text: 'In the 18th century, it was grown to provide wood for boxes and ______.',
    ...
    },
    {
      ...
      number: 26,
      type: 'summary-completion',
      text: "Due to its strength, elm was often used for mining equipment and the Cutty Sark's ______ was also constructed from elm.",
      correctAnswer: 'keel',
      location: 'Paragraph D',
    },
  ],
...
const passage3: Section = {
  id: 'stress-judgement-p3',
  title: 'Reading Passage 3: How stress affects our judgement',
  paragraphs: [
    {
      label: 'A',
      content:
...
export const fullReadingTest2: IELTSTest = {
  id: 'ielts-reading-full-vol2',
