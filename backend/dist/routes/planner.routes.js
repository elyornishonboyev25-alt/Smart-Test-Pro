...
router.post('/tasks', requireAuth, validateBody(createTaskSchema), asyncHandler(async (req, res) => {
...
router.patch('/tasks/:taskId', requireAuth, validateBody(updateTaskSchema), asyncHandler(async (req, res) => {
    const userId = req.user.id;
