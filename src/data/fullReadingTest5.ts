...
const headingOptionsAtoG = [
  'A. Tried and tested solutions',
  'B. Cooperation beneath the waves',
  'C. Working to lessen the problems',
  'D. Disagreement about the accuracy of a certain phrase',
  'E. Two clear educational goals',
  'F. Promoting hope',
  'G. A warning of further trouble ahead',
]

const expertOptionsAtoC = ['A. Martin Rees', 'B. Daniel Wolpert', 'C. Kathleen Richardson']

const endingOptionsAtoD = [
...
const passage1: Section = {
  id: 'frozen-food-p1-v5',
  title: 'Reading Passage 1: Frozen Food',
  paragraphs: [
    {
      label: 'A',
      content:
  ...
  questions: [
    {
      ...
      text: 'People conserved the nutritional value of ______, using a method of freezing then drying.',
    ...
    },
    {
      ...
      number: 2,
      type: 'note-completion',
      text: '______ was kept cool by ice during transportation in specially adapted trains.',
    ...
    },
    {
      ...
      number: 3,
      type: 'note-completion',
      text: 'Two kinds of ______ were the first frozen foods shipped to England.',
      correctAnswer: 'meat',
    ...
    },
    {
      ...
      number: 4,
      type: 'note-completion',
      text: 'Quick-freezing methods, so that ______ did not spoil the food.',
    ...
    },
    {
      ...
      number: 5,
      type: 'note-completion',
      text: 'Packaging products with ______, so the product was visible.',
    ...
    },
    {
      ...
      number: 6,
      type: 'note-completion',
      text: 'Frozen food became popular because of a shortage of ______.',
      correctAnswer: 'tin',
    ...
    },
    {
      ...
      number: 7,
      type: 'note-completion',
      text: 'A large number of homes now had a ______.',
...
const passage2: Section = {
  id: 'coral-reefs-p2-v5',
  title: 'Reading Passage 2: Can the planet\'s coral reefs be saved?',
  paragraphs: [
    {
      label: 'A',
      content:
  ...
  questions: [
    ...
    },
    {
      ...
      text: 'Corals have a number of ______ which they use to collect their food.',
    ...
    },
    {
      ...
      number: 25,
      type: 'note-completion',
      text: 'Algae gain ______ from being inside the coral.',
    ...
    },
    {
      ...
      number: 26,
      type: 'note-completion',
      text: 'Increases in the warmth of the sea water can remove the ______ from coral.',
...
const passage3: Section = {
  id: 'robots-and-us-p3-v5',
  title: 'Reading Passage 3: Robots and us',
  paragraphs: [
    {
      label: 'A',
      content:
  ...
  questions: [
    ...
    },
    {
      ...
      number: 34,
      type: 'matching-headings',
      groupTitle: 'Questions 34-36',
      instruction: 'Complete each sentence with the correct ending.',
      text: 'Richardson and Rees express similar views regarding the ethical aspect of ______',
      options: endingOptionsAtoD,
      correctAnswer: 'C',
      location: 'Paragraphs A and C',
    },
    {
      id: 'robots-q35',
      number: 35,
      type: 'matching-headings',
      text: 'Rees and Wolpert express similar views regarding ______',
      options: endingOptionsAtoD,
      correctAnswer: 'B',
      location: 'Paragraph D',
    },
    {
      ...
      number: 36,
      type: 'matching-headings',
      text: 'Wolpert disagrees with Richardson on the question of ______',
      options: endingOptionsAtoD,
      correctAnswer: 'D',
      location: 'Paragraph F',
    },
    ...
    },
    {
      ...
      text: 'According to Rees, who should be most worried about the idea of the \"singularity\"?',
      options: [
        'People who are underemployed and bored.',
        'Engineers building space robots.',
        'Futurologists who believe in it.',
        'All users of digital networks.',
      ],
      correctAnswer: 'C',
      location: 'Paragraph F',
    },
    {
      ...
      number: 39,
      type: 'multiple-choice',
      text: 'What does Wolpert say about AI misuse in the near future?',
      options: [
        'It will certainly cause more harm than good.',
        'Its benefits are likely to outweigh its negative aspects.',
        'It can only be prevented by stricter laws.',
        'It proves robots are becoming autonomous threats.',
      ],
      correctAnswer: 'B',
      location: 'Paragraph F',
    },
    {
      ...
      number: 40,
      type: 'multiple-choice',
      text: 'What does Richardson suggest could reduce people\'s fear of robots?',
      options: [
        'Keeping fiction and science completely separate.',
        'Stopping the creation of human-like machines.',
        'Bringing different understandings together for a fuller perspective.',
        'Focusing only on technical research evidence.',
      ],
      correctAnswer: 'C',
      location: 'Paragraph G',
    },
...
export const fullReadingTest5: IELTSTest = {
  id: 'ielts-reading-full-vol5',
