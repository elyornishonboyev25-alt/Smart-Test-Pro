...
export default function Tests() {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section className="mt-6 rounded-2xl border border-amber-200 bg-gradient-to-r from-amber-50/80 to-orange-50/60 p-4 text-sm text-amber-900">
        ...
        {trackCards.map((track) => {
          ...
          return (
            <motion.button
              ...
              whileHover={allowHoverMotion ? { y: -4, scale: 1.012 } : undefined}
              whileTap={allowHoverMotion ? { scale: 0.996 } : undefined}
              className={`interactive-lift group rounded-[1.8rem] border p-6 text-left ${toneClass(track.tone)}`}
            >
      ...
      <section className="mt-6 rounded-2xl border border-red-100 bg-white/90 p-4">
