          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <div className="grid gap-2 sm:grid-cols-3 xl:w-[31rem]">
              <div className="premium-stat-blue p-4">
                ...
                <p className="mt-1 text-3xl font-black text-slate-900">2</p>
          ...
          {sections.map((section) => {
            ...
            return (
              <motion.button
                ...
                className="interactive-lift group rounded-[1.8rem] border border-blue-200 bg-gradient-to-br from-white via-blue-50 to-indigo-100/75 p-6 text-left shadow-[0_18px_36px_rgba(37,99,235,0.16)]"
              >
